...
lay_optimize_3 = tc.optim.Adam(layer_gatelist_3, lr=lr)
lay_optimize_4 = tc.optim.Adam(layer_gatelist_4, lr=lr)


layer_optimize.append(lay_optimize_0)                               # 将三层优化器
layer_optimize.append(lay_optimize_1)
layer_optimize.append(lay_optimize_2)
layer_optimize.append(lay_optimize_3)
layer_optimize.append(lay_optimize_4)
...
scheduler_3 = StepLR(lay_optimize_3, step_size=step_size, gamma=0.1)
scheduler_4 = StepLR(lay_optimize_4, step_size=step_size, gamma=0.1)
...
scheduler.append(scheduler_3)
scheduler.append(scheduler_4)
...
plt.savefig('./MPS_Step_5layer_Circle.jpg')
