...
print('线路为' + str(layer_num) + '层量子门线路结构，先进行Circle固定某层优化')
print('学习率为:' + str(lr) + ', k_bood为: ' + str(k_bood) +
      ', 单位门小量vol为: ' + str(vol) + ', 协同优化单位门微扰小量con_vol' + str(con_vol) +
      ', NLF的精度范围为;'+ str(Loss_accuracy_range))
...
plt.savefig('./MPS_Step_4layer_Circle.jpg')
